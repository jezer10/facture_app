...
export const BETA_URL = 'https://e-beta.sunat.gob.pe/ol-ti-itcpfegem-beta/billService';
...
export function buildBetaInvoice(input) {
...
export function verifySignature(xml, certificate) {
...
export function signBetaInvoice(xml, privateKey, certificate) {
...
export function packageInvoice(fileBase, xml) {
...
export function betaEnvelope(issuerRuc, fileBase, zip) {
  ruc.parse(issuerRuc);
...
export function parseBetaResponse(xml, documentId, fileBase) {
...
export async function sendToBeta(envelope) {
